...
if __name__ == '__main__':
    ...
    #     for i in trange(144):
    #         for j in range(26 ** 2):
    #             if decrypting(decrypting(24,key_dict1[i % 12],key_dict2[j % 26]),key_dict1[math.floor(i/12)],
    ...
    #                                                     if decrypting(
    #                                                             decrypting(23, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                             key_dict1[math.floor(i / 12)],
    #                                                             key_dict2[math.floor(j / 26)]) == 5:
    #                                                         if decrypting(decrypting(6, key_dict1[i % 12],
    #                                                                                  key_dict2[j % 26]),
    #                                                                       key_dict1[math.floor(i / 12)],
    #                                                                       key_dict2[math.floor(j / 26)]) == 22:
    #                                                             if decrypting(decrypting(25, key_dict1[i % 12],
    #                                                                                      key_dict2[j % 26]),
    #                                                                           key_dict1[math.floor(i / 12)],
    ...
    #                                                                             if decrypting(decrypting(20, key_dict1[
    #                                                                                 i % 12], key_dict2[j % 26]),
    #                                                                                           key_dict1[
    #                                                                                               math.floor(i / 12)],
    #                                                                                           key_dict2[math.floor(
    #                                                                                               j / 26)]) == 8:
    #                                                                                 if decrypting(decrypting(4,
    #                                                                                                          key_dict1[
    #                                                                                                              i % 12],
    #                                                                                                          key_dict2[
    #                                                                                                              j % 26]),
