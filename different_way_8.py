...
if __name__ == '__main__':
    ...
    #     for i in trange(144):
    #         for j in range(26 ** 2):
    #             if decrypting(decrypting(15,key_dict1[i % 12],key_dict2[j % 26]),key_dict1[math.floor(i/12)],
    ...
    #                                     if decrypting(decrypting(1, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                   key_dict1[math.floor(i / 12)],
    ...
    #                                                 if decrypting(decrypting(0, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                               key_dict1[math.floor(i / 12)],
    #                                                               key_dict2[math.floor(j / 26)]) == 11:
    #                                                     if decrypting(
    #                                                             decrypting(2, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                             key_dict1[math.floor(i / 12)],
    #                                                             key_dict2[math.floor(j / 26)]) == 17:
    #                                                         if decrypting(decrypting(23, key_dict1[i % 12],
    #                                                                                  key_dict2[j % 26]),
    #                                                                       key_dict1[math.floor(i / 12)],
    ...
    #                                                                 if decrypting(decrypting(7, key_dict1[i % 12],
    #                                                                                          key_dict2[j % 26]),
    #                                                                               key_dict1[math.floor(i / 12)],
    ...
    #                                                                                       math.floor(j / 26)]) == 15:
    #                                                                         if decrypting(
    #                                                                                 decrypting(9, key_dict1[i % 12],
    #                                                                                            key_dict2[j % 26]),
    #                                                                                 key_dict1[math.floor(i / 12)],
    #                                                                                 key_dict2[math.floor(j / 26)]) == 12:
    #                                                                             if decrypting(decrypting(13, key_dict1[
    #                                                                                 i % 12], key_dict2[j % 26]),
    #                                                                                           key_dict1[
    #                                                                                               math.floor(i / 12)],
