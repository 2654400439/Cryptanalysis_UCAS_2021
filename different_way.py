...
# for i in range(200):
#     for j in range(13):
#         word_divide_3.append(C[i * 15 + j : i * 15 + j + 3])
# word_divide_3_count = Counter(word_divide_3)
# print(word_divide_3_count)
...
# x = [i for i in range(len(reference_list))]
# plt.scatter(x,reference_list)
# plt.show()
#
# x = [i for i in range(len(C1_counter))]
# plt.scatter(x,C1_counter)
# plt.show()
...
if __name__ == '__main__':
    ...
    # for i in trange(144):
    #     for j in range(26 ** 2):
    #         if decrypting(decrypting(1,key_dict1[i % 12],key_dict2[j % 26]),key_dict1[math.floor(i/12)],
    #                       key_dict2[math.floor(j/26)]) == 4:
    #             if decrypting(decrypting(0,key_dict1[i % 12],key_dict2[j % 26]),key_dict1[math.floor(i/12)],
    #                           key_dict2[math.floor(j/26)]) == 19:
    #                 if decrypting(decrypting(3, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    #                               key_dict2[math.floor(j / 26)]) == 0:
    #                     # if decrypting(decrypting(14, key_dict1[i % 12], key_dict2[j % 26]),
    #                     #               key_dict1[math.floor(i / 12)],key_dict2[math.floor(j / 26)]) not in [9,16,23,25]:
    #                     if decrypting(decrypting(14, key_dict1[i % 12], key_dict2[j % 26]),key_dict1[math.floor(i / 12)],
    ...
    #                                 if decrypting(decrypting(7, key_dict1[i % 12], key_dict2[j % 26]),
    #                                               key_dict1[math.floor(i / 12)],
    #                                               key_dict2[math.floor(j / 26)]) == 18:
    #                                     if decrypting(decrypting(8, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                   key_dict1[math.floor(i / 12)],
    #                                                   key_dict2[math.floor(j / 26)]) == 3:
    #                                         if decrypting(decrypting(16, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                       key_dict1[math.floor(i / 12)],
    #                                                       key_dict2[math.floor(j / 26)]) == 13:
    #                                             if decrypting(decrypting(4, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                           key_dict1[math.floor(i / 12)],
    #                                                           key_dict2[math.floor(j / 26)]) == 11:
    #                                                 if decrypting(decrypting(6, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                               key_dict1[math.floor(i / 12)],
    #                                                               key_dict2[math.floor(j / 26)]) == 7:
    #                                                     if decrypting(
    #                                                             decrypting(19, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                             key_dict1[math.floor(i / 12)],
    #                                                             key_dict2[math.floor(j / 26)]) == 20:
    #                                                         if decrypting(
    #                                                                 decrypting(20, key_dict1[i % 12],
    #                                                                            key_dict2[j % 26]),
    #                                                                 key_dict1[math.floor(i / 12)],
    #                                                                 key_dict2[math.floor(j / 26)]) == 5:
    #                                                             if decrypting(
    #                                                                     decrypting(22, key_dict1[i % 12],
    #                                                                                key_dict2[j % 26]),
    #                                                                     key_dict1[math.floor(i / 12)],
    #                                                                     key_dict2[math.floor(j / 26)]) == 1:
    #                                                                 if decrypting(
    #                                                                         decrypting(23, key_dict1[i % 12],
    #                                                                                    key_dict2[j % 26]),
    #                                                                         key_dict1[math.floor(i / 12)],
    #                                                                         key_dict2[math.floor(j / 26)]) == 12:
    #                                                                     if decrypting(
    #                                                                             decrypting(2, key_dict1[i % 12],
    #                                                                                        key_dict2[j % 26]),
    #                                                                             key_dict1[math.floor(i / 12)],
    #                                                                             key_dict2[math.floor(j / 26)]) == 15:
    #                                                                         if decrypting(
    #                                                                                 decrypting(15, key_dict1[i % 12],
    #                                                                                            key_dict2[j % 26]),
    #                                                                                 key_dict1[math.floor(i / 12)],
    #                                                                                 key_dict2[
    #                                                                                     math.floor(j / 26)]) == 2:
