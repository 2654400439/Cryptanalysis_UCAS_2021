...
if __name__ == '__main__':
    ...
    #     for i in trange(144):
    #         for j in range(26 ** 2):
    #             if decrypting(decrypting(20,key_dict1[i % 12],key_dict2[j % 26]),key_dict1[math.floor(i/12)],
    #                           key_dict2[math.floor(j/26)]) == 4:
    #                 if decrypting(decrypting(10, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    #                               key_dict2[math.floor(j / 26)]) == 0:
    #                     if decrypting(decrypting(25, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    #                                   key_dict2[math.floor(j / 26)]) == 19:
    #                         if decrypting(decrypting(23, key_dict1[i % 12], key_dict2[j % 26]),
    #                                       key_dict1[math.floor(i / 12)],
    ...
    #                                         if decrypting(decrypting(5, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                       key_dict1[math.floor(i / 12)],
    #                                                       key_dict2[math.floor(j / 26)]) == 11:
    #                                             if decrypting(decrypting(21, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                           key_dict1[math.floor(i / 12)],
    #                                                           key_dict2[math.floor(j / 26)]) == 7:
    #                                                 if decrypting(decrypting(11, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                               key_dict1[math.floor(i / 12)],
    #                                                               key_dict2[math.floor(j / 26)]) == 3:
    #                                                     if decrypting(
    #                                                             decrypting(16, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                             key_dict1[math.floor(i / 12)],
    ...
    #                                                             if decrypting(decrypting(14, key_dict1[i % 12],
    #                                                                                      key_dict2[j % 26]),
    #                                                                           key_dict1[math.floor(i / 12)],
    #                                                                           key_dict2[math.floor(j / 26)]) == 12:
    #                                                                 if decrypting(decrypting(18, key_dict1[i % 12],
    #                                                                                          key_dict2[j % 26]),
    #                                                                               key_dict1[math.floor(i / 12)],
    #                                                                               key_dict2[math.floor(j / 26)]) == 24:
    ...
    #                                                                                       math.floor(j / 26)]) == 6:
    #                                                                         if decrypting(
    #                                                                                 decrypting(19, key_dict1[i % 12],
    #                                                                                            key_dict2[j % 26]),
    #                                                                                 key_dict1[math.floor(i / 12)],
    #                                                                                 key_dict2[math.floor(j / 26)]) == 1:
    #                                                                             if decrypting(decrypting(8, key_dict1[
    #                                                                                 i % 12], key_dict2[j % 26]),
    #                                                                                           key_dict1[
    #                                                                                               math.floor(i / 12)],
    #                                                                                           key_dict2[math.floor(
    #                                                                                               j / 26)]) == 20:
    #                                                                                 if decrypting(decrypting(2,
    #                                                                                                          key_dict1[
    #                                                                                                              i % 12],
    #                                                                                                          key_dict2[
    #                                                                                                              j % 26]),
