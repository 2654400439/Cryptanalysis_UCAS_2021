...
if __name__ == '__main__':
    ...
    #     for i in trange(144):
    #         for j in range(26 ** 2):
    #             if decrypting(decrypting(11,key_dict1[i % 12],key_dict2[j % 26]),key_dict1[math.floor(i/12)],
    ...
    #                                                         if decrypting(decrypting(2, key_dict1[i % 12],
    #                                                                                  key_dict2[j % 26]),
    #                                                                       key_dict1[math.floor(i / 12)],
    ...
    #                                                                             if decrypting(decrypting(3, key_dict1[
    #                                                                                 i % 12], key_dict2[j % 26]),
    #                                                                                           key_dict1[
    #                                                                                               math.floor(i / 12)],
