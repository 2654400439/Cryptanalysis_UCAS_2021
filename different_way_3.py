...
if __name__ == '__main__':
    ...
    #                 if decrypting(decrypting(22, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    #                               key_dict2[math.floor(j / 26)]) == 19:
    #                     if decrypting(decrypting(2, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    ...
    #                                                                 if decrypting(
    #                                                                         decrypting(16, key_dict1[i % 12],
    #                                                                                    key_dict2[j % 26]),
    #                                                                         key_dict1[math.floor(i / 12)],
    #                                                                         key_dict2[math.floor(j / 26)]) == 5:
    #                                                                     if decrypting(
    #                                                                             decrypting(13, key_dict1[i % 12],
    #                                                                                        key_dict2[j % 26]),
    #                                                                             key_dict1[math.floor(i / 12)],
    #                                                                             key_dict2[math.floor(j / 26)]) == 24:
    #                                                                         if decrypting(
    #                                                                                 decrypting(18, key_dict1[i % 12],
    #                                                                                            key_dict2[j % 26]),
    #                                                                                 key_dict1[math.floor(i / 12)],
