...
if __name__ == '__main__':
    ...
    #                 if decrypting(decrypting(12, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    #                               key_dict2[math.floor(j / 26)]) == 19:
    #                     if decrypting(decrypting(17, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    ...
    #                                 if decrypting(decrypting(19, key_dict1[i % 12], key_dict2[j % 26]),
    #                                               key_dict1[math.floor(i / 12)],
    #                                               key_dict2[math.floor(j / 26)]) == 14:
    #                                     if decrypting(decrypting(20, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                   key_dict1[math.floor(i / 12)],
    ...
    #                                                     if decrypting(
    #                                                             decrypting(24, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                             key_dict1[math.floor(i / 12)],
    #                                                             key_dict2[math.floor(j / 26)]) == 3:
    #                                                         if decrypting(decrypting(16, key_dict1[i % 12],
    #                                                                                  key_dict2[j % 26]),
    #                                                                       key_dict1[math.floor(i / 12)],
    ...
    #                                                                 if decrypting(decrypting(5, key_dict1[i % 12],
    #                                                                                          key_dict2[j % 26]),
    #                                                                               key_dict1[math.floor(i / 12)],
    #                                                                               key_dict2[math.floor(j / 26)]) == 24:
    #                                                                     if decrypting(decrypting(21, key_dict1[i % 12],
    #                                                                                              key_dict2[j % 26]),
    #                                                                                   key_dict1[math.floor(i / 12)],
    #                                                                                   key_dict2[
    #                                                                                       math.floor(j / 26)]) == 20:
    #                                                                         if decrypting(
    #                                                                                 decrypting(25, key_dict1[i % 12],
    #                                                                                            key_dict2[j % 26]),
    #                                                                                 key_dict1[math.floor(i / 12)],
    #                                                                                 key_dict2[math.floor(j / 26)]) == 6:
    #                                                                             if decrypting(decrypting(6, key_dict1[
    #                                                                                 i % 12], key_dict2[j % 26]),
    #                                                                                           key_dict1[
    #                                                                                               math.floor(i / 12)],
    #                                                                                           key_dict2[math.floor(
    #                                                                                               j / 26)]) == 1:
    #                                                                                 if decrypting(decrypting(13,
    #                                                                                                          key_dict1[
    #                                                                                                              i % 12],
    #                                                                                                          key_dict2[
    #                                                                                                              j % 26]),
