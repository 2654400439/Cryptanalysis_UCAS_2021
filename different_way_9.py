...
if __name__ == '__main__':
    ...
    #                     if decrypting(decrypting(9, key_dict1[i % 12], key_dict2[j % 26]), key_dict1[math.floor(i / 12)],
    ...
    #                                         if decrypting(decrypting(3, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                       key_dict1[math.floor(i / 12)],
    #                                                       key_dict2[math.floor(j / 26)]) == 8:
    #                                             if decrypting(decrypting(2, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                           key_dict1[math.floor(i / 12)],
    ...
    #                                                     if decrypting(
    #                                                             decrypting(6, key_dict1[i % 12], key_dict2[j % 26]),
    #                                                             key_dict1[math.floor(i / 12)],
    #                                                             key_dict2[math.floor(j / 26)]) == 11:
    #                                                         if decrypting(decrypting(22, key_dict1[i % 12],
    #                                                                                  key_dict2[j % 26]),
    #                                                                       key_dict1[math.floor(i / 12)],
    ...
    #                                                                 if decrypting(decrypting(1, key_dict1[i % 12],
    #                                                                                          key_dict2[j % 26]),
    #                                                                               key_dict1[math.floor(i / 12)],
    #                                                                               key_dict2[math.floor(j / 26)]) == 6:
    ...
    #                                                                                       math.floor(j / 26)]) == 24:
    #                                                                         if decrypting(
    #                                                                                 decrypting(11, key_dict1[i % 12],
    #                                                                                            key_dict2[j % 26]),
    #                                                                                 key_dict1[math.floor(i / 12)],
    #                                                                                 key_dict2[math.floor(j / 26)]) == 16:
    #                                                                             if decrypting(decrypting(5, key_dict1[
    #                                                                                 i % 12], key_dict2[j % 26]),
    #                                                                                           key_dict1[
    #                                                                                               math.floor(i / 12)],
    #                                                                                           key_dict2[math.floor(
    #                                                                                               j / 26)]) == 10:
    #                                                                                 if decrypting(decrypting(7,
    #                                                                                                          key_dict1[
    #                                                                                                              i % 12],
    #                                                                                                          key_dict2[
    #                                                                                                              j % 26]),
